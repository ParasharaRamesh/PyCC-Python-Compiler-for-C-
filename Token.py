...
keywords = {'true':'TRUE','false':'FALSE','return':'RETURN','while':'WHILE','do':'DO','main':'MAIN','if':'IF', 'then':'THEN','else':'ELSE','int':'INT','float':'FLOAT','case':'CASE','default':'DEFAULT','switch':'SWITCH'}
...
def t_ID(t):
    ...
    #print()
    #print("INSIDE TOKEN t.type=",t.type)
    t.type = keywords.get(t.value,'ID')
    #print("INSIDE TOKEN t.type2=",t.type)
    #print()
    return t
...
def t_NUMBER(t):
    r'(\d+.\d+)|(\d+)'
    #we gotta make regex which accepts floats
    return t
